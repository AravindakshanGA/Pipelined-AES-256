module s_box_maker (clk,
 ...
 sky130_fd_sc_hd__and2_1 _458_ (.A(net8),
    ...
    .VPWR(VPWR),
    .X(_222_));
 sky130_fd_sc_hd__and2_1 _459_ (.A(net10),
    .B(net11),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__nor2_1 _462_ (.A(_201_),
    ...
    .VPWR(VPWR),
    .Y(_265_));
 sky130_fd_sc_hd__buf_2 _463_ (.A(net2),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_275_));
 sky130_fd_sc_hd__clkbuf_4 _464_ (.A(_275_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__nand2_1 _472_ (.A(_275_),
    ...
    .VPWR(VPWR),
    .Y(_371_));
 sky130_fd_sc_hd__buf_2 _473_ (.A(_371_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_382_));
 sky130_fd_sc_hd__buf_2 _474_ (.A(_382_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_393_));
 sky130_fd_sc_hd__buf_2 _475_ (.A(_393_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__clkbuf_4 _480_ (.A(_410_),
    ...
    .VPWR(VPWR),
    .X(_411_));
 sky130_fd_sc_hd__buf_2 _481_ (.A(_411_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__inv_2 _482_ (.A(net2),
    ...
    .VPWR(VPWR),
    .Y(_413_));
 sky130_fd_sc_hd__clkbuf_2 _483_ (.A(_413_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__buf_2 _489_ (.A(_419_),
    ...
    .VPWR(VPWR),
    .X(_420_));
 sky130_fd_sc_hd__buf_2 _490_ (.A(_420_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_421_));
 sky130_fd_sc_hd__buf_2 _491_ (.A(_414_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__xnor2_1 _497_ (.A(net21),
    ...
    .VPWR(VPWR),
    .Y(_427_));
 sky130_fd_sc_hd__buf_2 _498_ (.A(_427_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__or3_1 _500_ (.A(_413_),
    ...
    .VPWR(VPWR),
    .X(_430_));
 sky130_fd_sc_hd__buf_2 _501_ (.A(_430_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__inv_2 _502_ (.A(_431_),
    ...
    .VPWR(VPWR),
    .Y(_432_));
 sky130_fd_sc_hd__buf_2 _503_ (.A(_432_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__xnor2_1 _508_ (.A(_436_),
    ...
    .VPWR(VPWR),
    .Y(_437_));
 sky130_fd_sc_hd__buf_2 _509_ (.A(_437_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__buf_2 _521_ (.A(_410_),
    ...
    .VPWR(VPWR),
    .X(_450_));
 sky130_fd_sc_hd__a2111o_1 _522_ (.A1(_416_),
    .A2(_417_),
    .B1(_429_),
    .C1(_426_),
    .D1(_414_),
 ...
 sky130_fd_sc_hd__clkbuf_4 _523_ (.A(_451_),
    ...
    .VPWR(VPWR),
    .X(_452_));
 sky130_fd_sc_hd__or4_1 _524_ (.A(net9),
    .B(_414_),
    .C(_426_),
    .D(_429_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_453_));
 sky130_fd_sc_hd__buf_2 _525_ (.A(_453_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__inv_2 _531_ (.A(_371_),
    ...
    .VPWR(VPWR),
    .Y(_022_));
 sky130_fd_sc_hd__buf_2 _532_ (.A(_022_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__buf_2 _538_ (.A(_027_),
    ...
    .VPWR(VPWR),
    .X(_028_));
 sky130_fd_sc_hd__buf_2 _539_ (.A(net2),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__and3_1 _545_ (.A(_034_),
    ...
    .VPWR(VPWR),
    .X(_035_));
 sky130_fd_sc_hd__buf_2 _546_ (.A(_371_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_036_));
 sky130_fd_sc_hd__buf_2 _547_ (.A(_034_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__inv_2 _551_ (.A(_339_),
    ...
    .VPWR(VPWR),
    .Y(_041_));
 sky130_fd_sc_hd__buf_2 _552_ (.A(_041_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_042_));
 sky130_fd_sc_hd__buf_2 _553_ (.A(_042_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__clkbuf_4 _558_ (.A(_047_),
    ...
    .VPWR(VPWR),
    .X(_048_));
 sky130_fd_sc_hd__buf_2 _559_ (.A(_048_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__a21oi_2 _562_ (.A1(_029_),
    ...
    .VPWR(VPWR),
    .Y(_051_));
 sky130_fd_sc_hd__and4_1 _563_ (.A(_275_),
    .B(_024_),
    .C(_437_),
    .D(_432_),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__clkbuf_4 _567_ (.A(_450_),
    ...
    .VPWR(VPWR),
    .X(_056_));
 sky130_fd_sc_hd__or3_1 _568_ (.A(_414_),
    .B(_428_),
    .C(_432_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_057_));
 sky130_fd_sc_hd__buf_2 _569_ (.A(_057_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__clkbuf_4 _573_ (.A(_023_),
    ...
    .VPWR(VPWR),
    .X(_062_));
 sky130_fd_sc_hd__buf_2 _574_ (.A(_434_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__clkbuf_4 _578_ (.A(_425_),
    ...
    .VPWR(VPWR),
    .X(_067_));
 sky130_fd_sc_hd__buf_2 _579_ (.A(_410_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__and3_1 _581_ (.A(_067_),
    ...
    .VPWR(VPWR),
    .X(_070_));
 sky130_fd_sc_hd__nand2_1 _582_ (.A(_441_),
    .B(_440_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__o311a_1 _587_ (.A1(_062_),
    ...
    .VPWR(VPWR),
    .X(_076_));
 sky130_fd_sc_hd__buf_2 _588_ (.A(_046_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_077_));
 sky130_fd_sc_hd__buf_2 _589_ (.A(_077_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__a211o_1 _590_ (.A1(_350_),
    ...
    .VPWR(VPWR),
    .X(_079_));
 sky130_fd_sc_hd__clkbuf_4 _591_ (.A(_022_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_080_));
 sky130_fd_sc_hd__buf_2 _592_ (.A(_080_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__a211o_1 _596_ (.A1(_067_),
    ...
    .VPWR(VPWR),
    .X(_085_));
 sky130_fd_sc_hd__o31a_1 _597_ (.A1(_025_),
    .A2(_027_),
    .A3(_082_),
    .B1(_085_),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__or3b_1 _603_ (.A(_089_),
    ...
    .VPWR(VPWR),
    .X(_092_));
 sky130_fd_sc_hd__buf_2 _604_ (.A(_031_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__a32o_1 _610_ (.A1(_350_),
    ...
    .VPWR(VPWR),
    .X(_099_));
 sky130_fd_sc_hd__o211a_1 _611_ (.A1(_011_),
    .A2(_428_),
    .B1(_038_),
    .C1(_286_),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__o211a_1 _614_ (.A1(_088_),
    ...
    .VPWR(VPWR),
    .X(_103_));
 sky130_fd_sc_hd__and3_1 _615_ (.A(_029_),
    .B(_011_),
    .C(_438_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__nand2_1 _624_ (.A(_110_),
    ...
    .VPWR(VPWR),
    .Y(_113_));
 sky130_fd_sc_hd__or3_1 _625_ (.A(net8),
    .B(net21),
    .C(_451_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__a31o_1 _654_ (.A1(_023_),
    ...
    .VPWR(VPWR),
    .X(_141_));
 sky130_fd_sc_hd__a211o_1 _655_ (.A1(_024_),
    .A2(_012_),
    .B1(_428_),
    .C1(_422_),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__and3_1 _688_ (.A(_029_),
    ...
    .VPWR(VPWR),
    .X(_173_));
 sky130_fd_sc_hd__a21o_1 _689_ (.A1(_029_),
    .A2(_050_),
    .B1(_443_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__o211a_1 _695_ (.A1(_097_),
    ...
    .VPWR(VPWR),
    .X(_180_));
 sky130_fd_sc_hd__buf_2 _696_ (.A(_042_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_016_));
 sky130_fd_sc_hd__nand2_1 _697_ (.A(_024_),
    .B(_012_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__a21oi_1 _703_ (.A1(_093_),
    ...
    .VPWR(VPWR),
    .Y(_187_));
 sky130_fd_sc_hd__nor2_1 _704_ (.A(_068_),
    .B(_178_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__a211o_1 _736_ (.A1(_407_),
    ...
    .VPWR(VPWR),
    .X(_221_));
 sky130_fd_sc_hd__a21oi_1 _737_ (.A1(_167_),
    .A2(_083_),
    .B1(_063_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__dfxtp_1 _922_ (.CLK(net23),
    ...
    .VPWR(VPWR),
    .Q(net3));
 sky130_fd_sc_hd__dfxtp_2 _923_ (.CLK(net23),
    .D(_011_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__buf_2 output8 (.A(net8),
    ...
    .VPWR(VPWR),
    .X(wr_addr[4]));
 sky130_fd_sc_hd__buf_2 output9 (.A(net21),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__clkbuf_4 output19 (.A(net19),
    ...
    .VPWR(VPWR),
    .X(wr_data[7]));
 sky130_fd_sc_hd__buf_2 output20 (.A(net22),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(wr_enable));
 sky130_fd_sc_hd__clkbuf_4 fanout21 (.A(net9),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
